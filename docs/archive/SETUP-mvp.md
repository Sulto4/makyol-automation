> **Depreciat.** Acest document descrie setup-ul MVP single-service pe bare-metal (fără Docker, fără pipeline Python separat).
> Pentru instrucțiunile actuale vezi [../development.md](../development.md) și [../deployment.md](../deployment.md).
