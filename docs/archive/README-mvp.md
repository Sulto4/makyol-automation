> **Depreciat.** Acest document descrie sistemul MVP pre-hardening (single-service `pdf-parse` fără Vision, fără auth, fără pipeline Python separat).
> Pentru versiunea curentă a documentației vezi [../index.md](../index.md) sau [../../README.md](../../README.md).
