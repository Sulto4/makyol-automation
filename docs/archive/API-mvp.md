> **Depreciat.** Acest document descrie API-ul MVP fără autentificare și cu alte shape-uri de răspuns.
> Pentru referința actuală a rutelor vezi [../api-reference.md](../api-reference.md).
